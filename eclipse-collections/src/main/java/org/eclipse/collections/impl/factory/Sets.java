...
public final class Sets
{
     ...
     * way to use Eclipse-Collections APIs with existing JDK collections.
     *
     ...
     * <p>
     * Proper subset must have number of elements not equal to the number of elements of the superset
     * and must be smaller
     *
     * @param <E> the element type
